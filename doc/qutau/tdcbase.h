 ...
 *  and calculate start stop histograms.
 *
 *  @ref tdcbase.h declares functions for device control and timestamp acquisition.
 *
 *  @ref tdcstartstop.h allows to generate start stop histograms in the PC.
 *
 *  @ref tdchbt.h provides photon statistics with g(2) functions and fit to models.
 *
 *  @ref tdclifetm.h provides functions for lifetime measurement.
 */
/*****************************************************************************/
/** @file tdcbase.h
 ...
 */
/*****************************************************************************/
/* $Id: tdcbase.h,v 1.6 2015/07/31 11:57:32 trurl Exp $ */
 ...
 *  channel Numbers range from 0 to 7.
 ...
 *
 *  @li binary:     Records of 10 bytes, 8 bytes for the timestamp, 2 for the
 *                  channel number, stored in little endian (Intel) byte order.
 *                  Channel numbers range from 1 to 8 in this format.
 *
 *  @li compressed: Records of 50 bits (5 bytes), 37 for the timestamp, 3 for the
 *                  channel number, stored in little endian (Intel) byte order.
 *                  Channel numbers range from 0 to 7 in this format!
 *
 ...
 *  delayed processing. The function can only be used when a device is
 *  connected with HBT and Lifetime options configured;
 *  otherwise it will return an error.
 *
 *  It works only with files in a binary format (see @ref TDC_FileFormat).
 ...
 *  @param format     Input format. Only FORMAT_BINARY ore FORMAT_COMPRESSED
 *                    are valid.
 *  @return  Error code
 */

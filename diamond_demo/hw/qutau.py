...
tdcbase.TDC_getHistogram.argtypes = [c_int, c_int, c_bool, POINTER(c_int), POINTER(c_int), POINTER(c_int),
                                     POINTER(c_int), POINTER(c_int), POINTER(c_int), POINTER(c_int)]


def TDC_getHistogram(chanA=-1, chanB=-1, reset=False, data=None, count=None, tooSmall=None, tooLarge=None, eventsA=None,
                     eventsB=None, expTime=None):
    windll.tdcbase.TDC_getHistogram(chanA, chanB, reset, byref(data) if data is not None else None,
                                    byref(count) if count is not None else None,
                                    byref(tooSmall) if tooSmall is not None else None,
                                    byref(tooLarge) if tooLarge is not None else None,
                                    byref(eventsA) if eventsA is not None else None,
                                    byref(eventsB) if eventsB is not None else None,
                                    byref(expTime) if expTime is not None else None)
...
class TDC_HbtFunction(Structure):
    ...
    @property
    def values(self):
        addr = cast(self._values, POINTER(c_double))
...
tdcbase.TDC_analyseHbtFunction.argtypes = [POINTER(TDC_HbtFunction), POINTER(c_int), POINTER(c_int), POINTER(c_int),
...
tdcbase.TDC_getLftHistogram.argtypes = [c_bool, POINTER(c_int), POINTER(c_int), POINTER(c_int), POINTER(c_int),
                                        POINTER(c_long)]

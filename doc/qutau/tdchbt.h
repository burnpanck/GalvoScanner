 ...
 */
/*****************************************************************************/
/* $Id: tdchbt.h,v 1.2 2015/07/10 13:34:26 trurl Exp $ */
 ...
 *  size function values, each representing an time diff range of binWidth
 ...
 *
 *  Returns a set of recommended fit start values for a specific
 *  fit funcion.
 *  @param fctType  Type of function
 *  @return Array of @ref HBT_PARAM_SIZE parameter values; NULL if fctType is invalid.
 */
